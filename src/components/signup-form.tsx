...
export function SignUp() {
    ...
    const onSignUp = async () => {
        ...
        try {
            ...
            router.push(`/verify-code/${response.data.value}`)
            ...
            throw new Error(`Error in Sign Up Button ::: ${error}`)
        } finally {
            ...
            <form>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <Button type="submit" className="w-full" disabled={buttonDisable} onClick={onSignUp}>
                            Sign Up
                        </Button>
                    </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <Button variant="outline" onClick={() => signIn("google")} type="button" className="w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path
